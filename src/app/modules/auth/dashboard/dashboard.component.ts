...
// Updated NavigationItem to include sectionId for scrolling
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  // --- MODIFICATION START ---
  // Updated navigation to use sectionId for on-page scrolling
  ...
  // New method to handle smooth scrolling
